    ...
    <section className="px-6 py-16">
      <div className="mx-auto max-w-lg rounded-3xl bg-white p-10 shadow-card text-center">
        ...
        <p className="font-sans text-[1.05rem] leading-[2] text-wedding-textSecondary">
          <span className="font-medium text-wedding-pink">두 사람</span>이 꽃과
          나무처럼 걸어와
          <br />
          서로의 <span className="font-medium text-wedding-pink">모든 것</span>
          이 되기 위해
          <br />
        ...
        <p className="font-sans text-[1.05rem] leading-[2] text-wedding-textSecondary">
          ...
          <br />
          <br />
          <span className="font-medium text-wedding-pink">두 사람</span>이 만나
          <br />
          서로의 하루가 되어
          <br />
